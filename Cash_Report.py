...
class Cash_Report:
    ...
    def cash_report_pdf(self):
        ...
        pdf.cell(0, 10, text='Domicile Cash Report of {}'.format(self.agr_data[0]['Domicile_Date']),
        ...
        sl = 0
        self.total_fee = 0
        pdf.cell(17, 6, text='S.No.', border=1)
        pdf.cell(90, 6, text='Applicant Name', border=1)
        pdf.cell(40, 6, text='Payment Type', border=1)
        pdf.cell(40, 6, text='Govt Fee',new_x="LMARGIN", new_y="NEXT", border=1)
        pdf.set_font('courier', size=14)
        for row in self.agr_data:
            sl += 1
            pdf.cell(17, 6, text='{}'.format(sl), border=1)
            pdf.cell(90, 6, text='{}'.format(
                row['Applicant_Name']), border=1)
            pdf.cell(40, 6, text='{}'.format(
                row['Payment_Type']), border=1)
            pdf.cell(40, 6, text='{}'.format(
                row['Govt_Fee']),new_x="LMARGIN", new_y="NEXT", border=1)
            if row['Govt_Fee'].strip() == '200':
                self.total_fee = self.total_fee + 200
        print(self.total_fee)
        pdf.set_font('courier', 'B', size=14)
        pdf.cell(147, 6, text='Total:-', align='R', border=1)
        pdf.cell(40, 6, text='{}'.format(self.total_fee),new_x="LMARGIN", new_y="NEXT", border=1)
        pdf.ln(12)
        pdf.ln(6)
        pdf.cell(170, 6, text='Domicile Clerk', align='R',new_x="LMARGIN", new_y="NEXT")
        pdf.set_font('courier', 'BU', size=14)
        pdf.cell(50, 6, text='Accounts Assistant', align='L',new_x="LMARGIN", new_y="NEXT")
        pdf.ln(6)
    ...
    def domicile_note_sheet(self):
        ...
        #pdf.cell(20, 6, text='', align='C')
        pdf.set_fill_color(152, 163, 155)
        pdf.cell(0, 10, text='Domicile Note Sheet of {}'.format(self.agr_data[0]['Domicile_Date']),
                 ln=1, align='L', fill=True)
        pdf.ln(6)
        pdf.set_font('courier', size=14)
        sl = 0
        ...
        duplicate_dom = 0
        pdf.set_font('courier', 'B', size=14)
        pdf.cell(20, 6, text='S.No.', border=1)
        pdf.cell(120, 6, text='Applicant Name', border=1)
        pdf.cell(40, 6, text='Request Type', border=1, new_x="LMARGIN", new_y="NEXT")
        pdf.set_font('courier', size=14)
        for row in self.agr_data:
            sl += 1 
            pdf.cell(20, 6, text='{}'.format(sl), border=1)
            pdf.cell(120, 6, text='{}'.format(
                row['Applicant_Name']), border=1)
            pdf.cell(40, 6, text='{}'.format(
                row['Request_Type']), border=1, new_x="LMARGIN", new_y="NEXT")
        ...
        pdf.set_font('courier', 'BU', size=14)
        pdf.ln(6)
        pdf.cell(40, 6, text='Summery', align='L',new_x="LMARGIN", new_y="NEXT")
        pdf.set_font('courier', size=14)
        pdf.cell(40, 6, text='Total Online Entries:- {}'.format(online_counter),new_x="LMARGIN", new_y="NEXT")
        pdf.cell(40, 6, text='Total Duplicate Entries:- {}'.format(dup_counter),new_x="LMARGIN", new_y="NEXT")
        pdf.cell(40, 6, text='New Domiciles:- {}'.format(new_counter),new_x="LMARGIN", new_y="NEXT")
        pdf.cell(40, 6, text='Duplicate Domiciles:- {}'.format(duplicate_dom),new_x="LMARGIN", new_y="NEXT")
        pdf.cell(40, 6, text='Revised Domiciles:- {}'.format(revised_counter),new_x="LMARGIN", new_y="NEXT")
        pdf.cell(40, 6, text='Total Entries:- {}'.format(len(self.agr_data)),new_x="LMARGIN", new_y="NEXT")
        pdf.ln(12)
        pdf.ln(6)
        pdf.cell(170, 6, text='Domicile Clerk', align='R',new_x="LMARGIN", new_y="NEXT")
        pdf.set_font('courier', 'BU', size=14)
    ...
    def domicile_challan_list(self):
        ...
        for row in self.agr_data:
            sl += 1
            pdf.cell(15, 6, text='{}'.format(sl), border=1)
            pdf.cell(90, 6, text='{}'.format(
                row['Applicant_Name']), border=1, new_x="LMARGIN", new_y="NEXT")
            if row['Duplicate_Entry'] == 'Yes':
                dup_counter += 1
            if row['Application_Type'] == 'online':
                online_counter += 1
    ...
    def domicile_challan(self):
        ...
        pdf.cell(60, 6, text='PROVINCIAL', align='L')
        pdf.cell(70, 6, text='Treasury or Sub-Treasury', align='C')
        pdf.cell(60, 6, text='Form-32/A', align='C',new_x="LMARGIN", new_y="NEXT")

        pdf.cell(60, 6, text='Challan of Cash Paid in to', align='L')
        pdf.cell(70, 6, text='National Bank of Pakistan', align='C')
        pdf.cell(60, 6, text='', align='C',new_x="LMARGIN", new_y="NEXT")

        pdf.cell(60, 6, text='Challan No.', align='L')
        pdf.cell(70, 6, text='State Bank of Pakistan', align='C')
        pdf.cell(60, 6, text='', align='C',new_x="LMARGIN", new_y="NEXT")
        pdf.ln(4)
        pdf.cell(35, 6, text='By whom Tender', align='L', border='LTR')
        pdf.cell(65, 6, text='To be filled in the Remittes', align='C', border=1)
        pdf.cell(35, 6, text='Amount', align='C', border='LTRB')
        pdf.cell(60, 6, text='To be filled by the  the Treasury',
                 align='L', border='LTR',new_x="LMARGIN", new_y="NEXT")

        pdf.cell(35, 6, text='', align='L', border='LR')
        pdf.cell(30, 6, text='Names or', align='C', border='LR')
        pdf.cell(35, 6, text='Full Particulars ', align='C', border='LR')
        pdf.cell(35, 6, text='', align='C', border='LR')
        pdf.cell(60, 6, text='Departmental Office of',
                 align='L',  border='LR',new_x="LMARGIN", new_y="NEXT")

        pdf.cell(35, 6, text='', align='L', border='LR')
        pdf.cell(30, 6, text='designation', align='C', border='LR')
        pdf.cell(35, 6, text='of the ', align='C', border='LR')
        pdf.cell(35, 6, text='', align='C', border='LR')
        pdf.cell(60, 6, text='the Treasury', align='L', border='LBR',new_x="LMARGIN", new_y="NEXT")

        pdf.cell(35, 6, text='', align='L', border='LR')
        pdf.cell(30, 6, text='and address', align='C', border='LR')
        pdf.cell(35, 6, text='remittance and', align='C', border='LR')
        pdf.cell(35, 6, text='', align='C', border='LR')
        pdf.cell(30, 6, text='Head of', align='C', border='LR')
        pdf.cell(30, 6, text='Order of', align='C', border='LR',new_x="LMARGIN", new_y="NEXT")

        pdf.cell(35, 6, text='', align='L', border='LR')
        pdf.cell(30, 6, text='of the person', align='C', border='LR')
        pdf.cell(35, 6, text='of authority (if', align='C', border='LR')
        pdf.cell(35, 6, text='', align='C', border='LR')
        pdf.cell(30, 6, text='Account', align='C', border='LR')
        pdf.cell(30, 6, text='the Bank', align='C', border='LR',new_x="LMARGIN", new_y="NEXT")

        pdf.cell(35, 6, text='', align='L', border='LR')
        pdf.cell(30, 6, text='of whom behalf', align='C', border='LR')
        pdf.cell(35, 6, text='any) ', align='C', border='LR')
        pdf.cell(35, 6, text='', align='C', border='LR')
        pdf.cell(30, 6, text='', align='C', border='LR')
        pdf.cell(30, 6, text='', align='C', border='LR',new_x="LMARGIN", new_y="NEXT")

        pdf.cell(35, 6, text='', align='L', border='LBR')
        pdf.cell(30, 6, text='money is paid', align='C', border='LBR')
        pdf.cell(35, 6, text='', align='C', border='LBR')
        pdf.cell(35, 6, text='', align='C', border='LBR')
        pdf.cell(30, 6, text='', align='C', border='LBR')
        pdf.cell(30, 6, text='', align='C', border='LBR',new_x="LMARGIN", new_y="NEXT")

        pdf.cell(35, 6, text='Domicile Branch', align='L', border='LR')
        pdf.cell(30, 6, text='District', align='C', border='LR')
        pdf.cell(35, 6, text='Domicile Fee', align='C', border='LR')
        pdf.cell(35, 6, text='{}'.format(
            self.total_fee), align='C', border='LR')
        pdf.cell(30, 6, text='C-03806', align='C', border='LR')
        pdf.cell(30, 6, text='', align='C', border='LR',new_x="LMARGIN", new_y="NEXT")

        pdf.cell(35, 6, text='DC Office, ICT', align='L', border='LR')
        pdf.cell(30, 6, text='Magistrate', align='C', border='LR')
        pdf.cell(35, 6, text='as per', align='C', border='LR')
        pdf.cell(35, 6, text='', align='C', border='LR')
        pdf.cell(30, 6, text='', align='C', border='LR')
        pdf.cell(30, 6, text='', align='C', border='LR',new_x="LMARGIN", new_y="NEXT")

        pdf.cell(35, 6, text='Islamabad', align='L', border='LR')
        pdf.cell(30, 6, text='Islamabad', align='C', border='LR')
        pdf.cell(35, 6, text='attached list', align='C', border='LR')
        pdf.cell(35, 6, text='', align='C', border='LR')
        pdf.cell(30, 6, text='', align='C', border='LR')
        pdf.cell(30, 6, text='', align='C', border='LR',new_x="LMARGIN", new_y="NEXT")

        pdf.cell(35, 6, text='', align='L', border='LR')
        pdf.cell(30, 6, text='{}'.format(challan_date), align='C', border='LR')
        pdf.cell(35, 6, text='', align='C', border='LR')
        pdf.cell(35, 6, text='', align='C', border='LR')
        pdf.cell(30, 6, text='', align='C', border='LR')
        pdf.cell(30, 6, text='', align='C', border='LR',new_x="LMARGIN", new_y="NEXT")
        ...
        pdf.cell(35, 8, text='', align='L', border='LBR')
        pdf.cell(30, 8, text='', align='C', border='LBR')
        pdf.cell(35, 8, text='Total', align='C', border='LBR')
        pdf.cell(35, 8, text='{}'.format(
            self.total_fee), align='C', border='LBR')
        pdf.cell(30, 8, text='', align='C', border='LBR')
        pdf.cell(30, 8, text='', align='C', border='LBR',new_x="LMARGIN", new_y="NEXT")

        pdf.set_font('Times', size=12)
        pdf.cell(65, 10, text='In words Rupees ', align='R')
        pdf.set_font('Times', 'B', size=12)
        pdf.cell(0, 10, text='{} Only'.format(
            num2words(self.total_fee)), align='L',new_x="LMARGIN", new_y="NEXT")
        pdf.ln(5)
        pdf.set_font('Times', size=12)
        pdf.cell(50, 5, text='Signature', align='C')
        pdf.cell(50, 5, text='Amount', align='C')
        pdf.cell(50, 5, text='Received', align='C')
        pdf.cell(50, 5, text='Treasury Officer', align='C',new_x="LMARGIN", new_y="NEXT")

        pdf.cell(50, 5, text='', align='C')
        pdf.cell(50, 5, text='', align='C')
        pdf.cell(50, 5, text='Payment Treasury', align='C')
        pdf.cell(50, 5, text='', align='C',new_x="LMARGIN", new_y="NEXT")
        pdf.ln(2)
        pdf.cell(0, 1, text='', border='T',new_x="LMARGIN", new_y="NEXT")
        # second page
        pdf.ln(2)
        pdf.set_font('Times', size=12)
